...
public class JellyTextView extends android.support.v7.widget.AppCompatTextView {
    ...
    public JellyTextView(Context context) {
        super(context); mScroller = new OverScroller(context, new BounceInterpolator());
    }

    public JellyTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr); mScroller = new OverScroller(context, new BounceInterpolator());
    }
